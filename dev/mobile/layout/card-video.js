  ...
  <li class="ClipCardV2_list_item__BUsI8 ClipCardV2_in_home_chipcloud__wh0rI ClipCardV2_column5__EMBmN">
    ...
    <div class="card-video-details">
      <div class="card-video-channel-emblem">
        <a class="card-video-link-emblem" data-nlog-area="chip.chhome" data-nlog-code="Mnavertv.home" data-nlog-gdid-send="category" @click="${this._onClickLink(this.data?.owner?.endpoint?.url)}" href="${this.data?.owner?.endpoint?.url}"><span style="box-sizing: border-box; display: inline-block; overflow: hidden; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: relative; max-width: 100%;"><span style="box-sizing: border-box; display: block; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; max-width: 100%;"><img alt="" aria-hidden="true" src="data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%2734%27%20height=%2734%27/%3e" style="display: block; max-width: 100%; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px;"></span><img alt="낮과 밤이 다른 그녀 로고" src="https://phinf.pstatic.net/tvcast/20240516_129/r0iu7_1715822248664LwOxN_PNG/20240516_101424_276.png?type=round_64_64" decoding="async" data-nimg="intrinsic" style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;"><noscript></noscript></span></a>
      </div>
